...
/**
 * \file    test/phpunit/Mlab_propal_addonFunctionalTest.php
...
/**
 * Class Mlab_propal_addonFunctionalTest
 *
 ...
 *
 * @package Testmlab_propal_addon
 */
class Mlab_propal_addonFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modMlab_propal_addon')->click();
		} else {
			// Disable the module
			$this->byHref('modMlab_propal_addon')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/mlab_propal_addon/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('mlab_propal_addon/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/mlab_propal_addon/admin/about.php');
		$this->authenticate();
		return $this->assertContains('mlab_propal_addon/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('mlab_propal_addonwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modMlab_propal_addon_Mlab_propal_addonTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modMlab_propal_addon_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
